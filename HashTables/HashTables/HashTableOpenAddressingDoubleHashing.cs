...
public class HashTableOpenAddressingDoubleHashing<TKey, TValue> : IHashTable<TKey, TValue>
{
    public string Name { get; } = "HashTable with open addressing using double hashing";
    ...
    public void Add(TKey key, TValue value)
    {
        ...
        while (_items[index].Key != null)
        {
            ...
            index = (index + i * GetSecondHash(key)) % _capacity;
            i++;
        }
    ...
    private int GetSecondHash(TKey key)
    {
        var hashCode = key.GetHashCode();
        var prime = 17;
